                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">You can manage the data here</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- table start -->
                            <div class="card-body">
                                        ...
                                        @foreach($posts as $index => $post)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin_panel.edit', $post->id) }}" class="btn btn-primary">Edit</a>

                                                    <form action="{{ route('admin_panel.destroy', $post->id) }}" method="POST" style="display: inline-block;">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <td>
                                                    <!-- Change Status Form -->
                                                    <form action="{{ route('admin_panel.change_status', $post->id) }}" method="POST" class="status-change-form" style="display: grid;">
                                                        @csrf
