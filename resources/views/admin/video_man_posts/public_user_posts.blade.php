...
@section('content')
    <div class="container">
        <div class="container-fluid">
            ...
            <div class="mb-3">
                <form action="{{ route('video_man_posts.public_user_posts') }}" method="GET" class="form-inline">
            ...
            <table class="table table-bordered">
                ...
                @foreach($publicUserPosts as $index => $post)
                    <tr>
                        ...
                        <td><a href="{{ route('public_user_posts.show', $post->id) }}">{{ $post->idea }}</a></td>
                        <td>
                            @if($post->photo)
                                <a href="{{ route('public_user_posts.show', $post->id) }}">
                        ...
                        <td>
                            <form action="{{ route('video_man_posts.update_status', $post->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
